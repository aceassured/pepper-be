...
export const sendContactMail = async (contact: ContactDto) => {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; background-color: #f9f9f9; border-radius: 10px; border: 1px solid #e0e0e0; color: #1F2937;">
        <div style="text-align: center; margin-bottom: 20px;">
          <img src="https://res.cloudinary.com/dxzynb5wu/image/upload/v1762773774/K_p_favicon_otfe0b.png" alt="Kumbuckal Pepper" style="height: 60px;">
        </div>
        ...
        <p style="text-align: center; font-size: 12px; color: #111827;">
          This message was sent from the Kumbuckal Pepper Contact Form.
        </p>
      </div>
    `,
  };
  ...
  const userOptions = {
    from: "Kumbuckal Pepper Nursery <no-reply@kumbuckalpepper.com>",
    to: email,
    subject: 'Thank You for Contacting Kumbuckal Pepper',
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; background-color: #f9f9f9; border-radius: 10px; border: 1px solid #e0e0e0; color: #1F2937;">
        <div style="text-align: center; margin-bottom: 20px;">
          <img src="https://res.cloudinary.com/dxzynb5wu/image/upload/v1762773774/K_p_favicon_otfe0b.png" alt="Kumbuckal Pepper" style="height: 60px;">
